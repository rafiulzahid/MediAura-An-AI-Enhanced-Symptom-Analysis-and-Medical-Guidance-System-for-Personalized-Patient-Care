...
@app.route('/about_doctors')
def about_doctors():
    return render_template('about_doctors.html')
...
def chatbot_api():
    ...
    if not user_query:
        return jsonify({"response": "Please enter a question.", "sources": []})

    result = get_answer(user_query)  # call RAG
    return jsonify({
